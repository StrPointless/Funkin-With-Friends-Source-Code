...
class CreditsState extends MusicBeatState
{
	...
	private static var creditsStuff:Array<Dynamic> = [ //Name - Icon name - Description - Link - BG Color
		['Funkin W/ Friends / FCE Mod'],
		['FFV',		'ffv',		'Concept artist and Leader of Mod team',					'https://discord.gg/VmwZf4PPvG',	0xFFFFDD33],
		['StrPointless',			'str',		'Coded Drew and animate 99.9% of the mod. (ngl i did a lot of shit)',				'https://discord.gg/VmwZf4PPvG',		0xFFC30085],
		['Emtmm',			'em',		'Created the insts to the 3 main songs',				'https://discord.gg/VmwZf4PPvG',		0xFFC30085],
		['oddlandz',			'oddlandz',		'Did the vocals for all three songs',				'https://discord.gg/VmwZf4PPvG',		0xFFC30085],
		[''],
		['Psych Engine Team'],
	...
	override function update(elapsed:Float)
	{
		...
		if(controls.ACCEPT) {
			...
			if(curSelected == 1)
			{
				...
				var achieveID:Int = Achievements.getAchievementIndex('str_homie');
				Achievements.achievementsMap.set(Achievements.achievementsStuff[achieveID][2], true);
				giveAchievement('str_homie');
