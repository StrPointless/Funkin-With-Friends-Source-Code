...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		...
		//["STR's Homie" ,                "You clicked my icon, You must've enjoyed sum shit, thx", 'str_homie',       false],
		["Secret Secret",               "You found one of my meme screens, cool! - STR",     'memeage',              false],
		["True Secret Secret",          "You found a even rarer meme screen, damn! -STR",    'true_memage',          false],
		["FFV Defeater",                "You beat him? Really? No hacks? Zamn alright i see you", 'week1_win',        false],
		["FFV Champion",                "There's no fucking way you fc'd that, YOUR HACKING FOR SURE",  'week1_nomiss',    false],
	];
